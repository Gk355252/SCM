...
public class SecurityConfig {
    ...
    // this is hardcode login credentials
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception {
        ...
        httpSecurity.formLogin(formLogin -> {
            ...
            // initially page is at /login but when you submit the login page then it shoould be submitted at /authenticate
        ...
        // we disabled csrf so that we can logout using get
